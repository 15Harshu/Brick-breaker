...
public class Board extends JPanel implements Runnable, Constants {
	...
	private int score = 0, lives = MAX_LIVES, bricksLeft = MAX_BRICKS, waitTime = 15, xSpeed, withSound, level = 1;
	...
	public Board(int width, int height) {
		...
		withSound = JOptionPane.showOptionDialog(null, "DO YOU WANT PLAY!!!", "About the Game", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
